        ...
        try {
            ...
            if (this.fromChunk instanceof ImposterProtoChunk wrappedFull) {
                ...
                chunk = new LevelChunk(this.world, protoChunk, (final LevelChunk unused) -> {
                    ChunkStatusTasks.postLoadProtoChunk(world, protoChunk.getEntities(), protoChunk.getPos()); // Paper - rewrite chunk system
                });
            ...
            try {
                this.chunkHolder.vanillaChunkHolder.currentlyLoading = chunk;
                chunk.runPostLoad();
                ...
                this.chunkHolder.vanillaChunkHolder.currentlyLoading = null;
            }
            ...
            try {
                ...
                NeoForge.EVENT_BUS.post(new ChunkEvent.Load(chunk, !((ProtoChunk)this.fromChunk instanceof ImposterProtoChunk)));
            } finally {
                this.chunkHolder.vanillaChunkHolder.currentlyLoading = null;
            }
