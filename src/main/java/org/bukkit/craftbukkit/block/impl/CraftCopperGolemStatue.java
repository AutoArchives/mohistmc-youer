...
public final class CraftCopperGolemStatue extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.CopperGolemStatue, org.bukkit.block.data.Directional, org.bukkit.block.data.Waterlogged {
    ...
    public CraftCopperGolemStatue(net.minecraft.world.level.block.state.IBlockData state) {
        super(state);
    }
    ...
    private static final net.minecraft.world.level.block.state.properties.BlockStateBoolean WATERLOGGED = getBoolean(net.minecraft.world.level.block.CopperGolemStatueBlock.class, "waterlogged");
