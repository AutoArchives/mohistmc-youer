...
public final class CraftChestTrapped extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Chest, org.bukkit.block.data.Directional, org.bukkit.block.data.Waterlogged {
    ...
    private static final org.bukkit.craftbukkit.block.data.CraftBlockStateEnum<?, org.bukkit.block.data.type.Chest.Type> TYPE = getEnum(net.minecraft.world.level.block.TrappedChestBlock.class, "type", org.bukkit.block.data.type.Chest.Type.class);
    ...
    private static final org.bukkit.craftbukkit.block.data.CraftBlockStateEnum<?, org.bukkit.block.BlockFace> FACING = getEnum(net.minecraft.world.level.block.TrappedChestBlock.class, "facing", org.bukkit.block.BlockFace.class);
