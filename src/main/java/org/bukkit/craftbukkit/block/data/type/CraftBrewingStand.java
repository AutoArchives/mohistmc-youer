...
public abstract class CraftBrewingStand extends CraftBlockData implements BrewingStand {
    ...
    private static final net.minecraft.world.level.block.state.properties.BooleanProperty[] HAS_BOTTLE = new net.minecraft.world.level.block.state.properties.BlockStateBoolean[]{
