...
public abstract class CraftChiseledBookshelf extends CraftBlockData implements ChiseledBookshelf {
    ...
    private static final net.minecraft.world.level.block.state.properties.BooleanProperty[] SLOT_OCCUPIED = new net.minecraft.world.level.block.state.properties.BlockStateBoolean[]{
