...
public final class CraftAttackRangeComponent implements AttackRangeComponent {
    ...
    public float getMinReach() {
        return handle.minRange();
    }

    @Override
    public void setMinReach(float reach) {
        handle = new AttackRange(reach, handle.maxRange(), handle.minCreativeRange(), handle.maxCreativeRange(), handle.hitboxMargin(), handle.mobFactor());
    }

    @Override
    public float getMaxReach() {
        return handle.maxRange();
    }

    @Override
    public void setMaxReach(float reach) {
        handle = new AttackRange(handle.minRange(), reach, handle.minCreativeRange(), handle.maxCreativeRange(), handle.hitboxMargin(), handle.mobFactor());
    }

    @Override
    public float getMinCreativeReach() {
        return handle.minCreativeRange();
    }

    @Override
    public void setMinCreativeReach(float reach) {
        handle = new AttackRange(handle.minRange(), handle.maxRange(), reach, handle.maxCreativeRange(), handle.hitboxMargin(), handle.mobFactor());
    }

    @Override
    public float getMaxCreativeReach() {
        return handle.maxCreativeRange();
    }

    @Override
    public void setMaxCreativeReach(float reach) {
        handle = new AttackRange(handle.minRange(), handle.maxRange(), handle.minCreativeRange(), reach, handle.hitboxMargin(), handle.mobFactor());
    }
    ...
    public void setHitboxMargin(float margin) {
        handle = new AttackRange(handle.minRange(), handle.maxRange(), handle.minCreativeRange(), handle.maxCreativeRange(), margin, handle.mobFactor());
    }
    ...
    public void setMobFactor(float factor) {
        handle = new AttackRange(handle.minRange(), handle.maxRange(), handle.minCreativeRange(), handle.maxCreativeRange(), handle.hitboxMargin(), handle.mobFactor());
    }
