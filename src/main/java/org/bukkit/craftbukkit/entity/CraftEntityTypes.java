...
public final class CraftEntityTypes {
    ...
    static {
        ...
        register(new EntityTypeData<>(EntityType.SPLASH_POTION, SplashPotion.class, CraftSplashPotion::new, spawnData -> {
            ThrownPotion entity = new ThrownSplashPotion(spawnData.minecraftWorld(), spawnData.x(), spawnData.y(), spawnData.z(), new net.minecraft.world.item.ItemStack(Items.SPLASH_POTION));
            return entity;
        }));
        register(new EntityTypeData<>(EntityType.LINGERING_POTION, LingeringPotion.class, CraftLingeringPotion::new, spawnData -> {
            ThrownPotion entity = new ThrownLingeringPotion(spawnData.minecraftWorld(), spawnData.x(), spawnData.y(), spawnData.z(), new net.minecraft.world.item.ItemStack(Items.LINGERING_POTION));
            return entity;
        }));
