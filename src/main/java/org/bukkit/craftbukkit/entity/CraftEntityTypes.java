...
public final class CraftEntityTypes {
    ...
    static {
        ...
        register(new EntityTypeData<>(EntityType.MANNEQUIN, Mannequin.class, CraftMannequin::new, createLiving(EntityTypes.MANNEQUIN)));
        ...
        register(new EntityTypeData<>(EntityType.HAPPY_GHAST, HappyGhast.class, CraftHappyGhast::new, createLiving(EntityTypes.HAPPY_GHAST)));
        ...
        register(new EntityTypeData<>(EntityType.COPPER_GOLEM, CopperGolem.class, CraftCopperGolem::new, createLiving(EntityTypes.COPPER_GOLEM)));
        ...
        register(new EntityTypeData<>(EntityType.CAMEL_HUSK, CamelHusk.class, CraftCamelHusk::new, createLiving(EntityTypes.CAMEL_HUSK)));
        register(new EntityTypeData<>(EntityType.NAUTILUS, Nautilus.class, CraftNautilus::new, createLiving(EntityTypes.NAUTILUS)));
        register(new EntityTypeData<>(EntityType.PARCHED, Parched.class, CraftParched::new, createLiving(EntityTypes.PARCHED)));
        register(new EntityTypeData<>(EntityType.ZOMBIE_NAUTILUS, ZombieNautilus.class, CraftZombieNautilus::new, createLiving(EntityTypes.ZOMBIE_NAUTILUS)));
            ...
            for (BlockFace dir : faces) {
                ...
                if (nmsBlock.isSolid() || BlockDiodeAbstract.isDiode(nmsBlock)) {
                    ...
                    AxisAlignedBB bb = (ItemFrame.class.isAssignableFrom(clazz))
                            ? EntityItemFrame.createBoundingBox(pos, CraftBlock.blockFaceToNotch(dir).getOpposite(), false)
