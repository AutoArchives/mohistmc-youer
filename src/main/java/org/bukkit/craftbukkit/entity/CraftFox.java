...
public class CraftFox extends CraftAnimals implements Fox {
    ...
    public AnimalTamer getFirstTrustedPlayer() {
        UUID uuid = this.getHandle().getEntityData().get(net.minecraft.world.entity.animal.Fox.DATA_TRUSTED_ID_0).map(EntityReference::getUUID).orElse(null);
        if (uuid == null) {
            return null;
        }
    ...
    public AnimalTamer getSecondTrustedPlayer() {
        UUID uuid = this.getHandle().getEntityData().get(net.minecraft.world.entity.animal.Fox.DATA_TRUSTED_ID_1).map(EntityReference::getUUID).orElse(null);
        if (uuid == null) {
            return null;
        }
