...
public class CraftBee extends CraftAnimals implements Bee {
    ...
    public net.minecraft.world.entity.animal.bee.Bee getHandle() {
        return (net.minecraft.world.entity.animal.bee.Bee) entity;
    }
    ...
    public void setHive(Location location) {
        ...
        getHandle().setHivePos((location == null) ? null : CraftLocation.toBlockPosition(location));
    }
    ...
    public void setAnger(int anger) {
        getHandle().setTimeToRemainAngry(anger);
    }
