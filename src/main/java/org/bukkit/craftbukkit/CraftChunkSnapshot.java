...
public class CraftChunkSnapshot implements ChunkSnapshot {
    ...
    CraftChunkSnapshot(int x, int z, int minHeight, int maxHeight, int seaLevel, String wname, long wtime, DataPaletteBlock<IBlockData>[] sectionBlockIDs, byte[][] sectionSkyLights, byte[][] sectionEmitLights, boolean[] sectionEmpty, HeightMap hmap, PalettedContainerRO<Holder<BiomeBase>>[] biome) {
        this.x = x;
        this.z = z;
