...
public abstract class CraftParticle<D> implements Keyed {
    ...
    public static class CraftParticleRegistry extends CraftRegistry<CraftParticle<?>, net.minecraft.core.particles.Particle<?>> {
        ...
        static {
            ...
            BiFunction<NamespacedKey, net.minecraft.core.particles.Particle<?>, CraftParticle<?>> sculkChargeFunction = (name, particle) -> new CraftParticle<>(name, particle, Float.class) {
                @Override
            ...
            BiFunction<NamespacedKey, net.minecraft.core.particles.Particle<?>, CraftParticle<?>> powerParticleFunction = (name, particle) -> new CraftParticle<>(name, particle, Float.class) {
                @Override
                public ParticleParam createParticleParam(Float data) {
                    return PowerParticleOption.create((net.minecraft.core.particles.Particle<PowerParticleOption>) getHandle(), data);
                }
            };
            ...
            BiFunction<NamespacedKey, net.minecraft.core.particles.Particle<?>, CraftParticle<?>> spellFunction = (name, particle) -> new CraftParticle<>(name, particle, Particle.Spell.class) {
                @Override
                public ParticleParam createParticleParam(Particle.Spell data) {
                    return SpellParticleOption.create((net.minecraft.core.particles.Particle<SpellParticleOption>) getHandle(), data.getColor().asARGB(), data.getPower());
                }
            };
